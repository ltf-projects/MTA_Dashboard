...
const MACHINE_FIELDS = [
  ...
  { key: 'AnalogData2', tr: 'Çamur Pompa Basıncı', min: 0, max: 250, zones: zones(190, 215, 250) },
  { key: 'AnalogData3', tr: 'Servis Pompa Basıncı', min: 0, max: 250, zones: zones(190, 212, 250) },
  { key: 'AnalogData4', tr: 'Baskı Basıncı', min: 0, max: 270, zones: zones(205, 232, 270) },
  { key: 'AnalogData5', tr: 'Askı Basıncı', min: 0, max: 270, zones: zones(205, 232, 270) },
  { key: 'AnalogData6', tr: 'Morset Yağlama', min: 0, max: 50, zones: zones(20, 27, 50), tickDecimals: 1 },
  { key: 'AnalogData7', tr: 'Ana Vinç Çekme Kuvveti', min: 0, max: 320, zones: zones(240, 275, 320) },
  { key: 'AnalogData8', tr: 'Rotasyon Tork', min: 0, max: 320, zones: zones(240, 275, 320) },
